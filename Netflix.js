 // API key from TMDB
const api = "cc02171804c1adeb8490421a86f874b7";
// Base URL of the site
const base_url = "https://api.themoviedb.org/3";

const banner_url = "https://image.tmdb.org/t/p/original";
const img_url = "https://image.tmdb.org/t/p/w500"; // you can change it to "w185" according to your pixel preference
...
// Used to truncate the string (movie description)
...
fetch(requests.fetchActionMovies)
    ...
    .then((data) => {
        ...
        data.results.forEach((movie) => {
            ...
            description.innerText = truncate(movie.overview, 100);
            

            row_posters.appendChild(description);
        });
        console.log("row_poster")
    });
